...
const uint8_t font_p[347][9] = { // proportional font
        /*POS.     LEN   1     2     3     4     5     6     7     8            UTF-8   CH   NAME  */
        /*0000*/ { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   // 0x0020,      SPACE 1 PIXEL
      /*0001 ♥*/ { 0x15, 0x66, 0xFF, 0xFB, 0xF7, 0x7E, 0x3C, 0x18, 0x08 },   // 0x0021, !    EXCLAMATION MARK
     // /*0001*/ { 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01, 0x00 },   // 0x0021, !    EXCLAMATION MARK
        ...
        /*0003=)*/ { 0x15, 0x66, 0x66, 0x00, 0x81, 0x81, 0xC3, 0x3C, 0x00 },   // 0x0023, #    NUMBER SIGN
     //   /*0003*/ { 0x05, 0x0a, 0x0a, 0x1f, 0x0a, 0x1f, 0x0a, 0x0a, 0x00 },   // 0x0023, #    NUMBER SIGN
        /*0004*/ { 0x15, 0x66, 0x66, 0x00, 0x81, 0x7E, 0x15, 0x11, 0x0E },   // 0x0024, $    DOLLAR SIGN
        ...
        /*0346*/ { 0x66, 0xFB, 0x76, 0x3C, 0x18, 0x10, 0x00, 0x00, 0x00 },   // 0xe299a5 ♥
...
//          ------------------------------------- posição segundos unidade original 6 display
            /*
            if (sc1 == 1) {
                if (_f_updown == 1) y--;
                else                y++;
            ...
            */
//          ------------------------------------- posição segundos dezena original 6 display
            /*
            if (sc2 == 1) {
            ...
            */
//          ------------------------------------- posição minuto unidade original (6 dysplay)
            /*
            if (sc3 == 1) {
            ...
            */
            if (sc3 == 1) {
                char2Arr_t(48 + min12, _zPosX - 41, y);
                char2Arr_t(48 + min11, _zPosX - 41, y + y1);
                if (y == 0) sc3 = 0;
            }
            else char2Arr_t(48 + min1, _zPosX - 41, 0);
//          ------------------------------------- posição minuto dezena original (6dysplay)
            /*
            if (sc4 == 1) {
...
//          
            */
            if (sc4 == 1) {
                char2Arr_t(48 + min22, _zPosX - 34 , y);
                char2Arr_t(48 + min21, _zPosX - 34, y + y1);
                if (y == 0) sc4 = 0;
            }
            else char2Arr_t(48 + min2, _zPosX - 34, 0);
            char2Arr_t(':', _zPosX - 31 + x, 0);
//          ------------------------------------- hora unidade original 6 display
            /*
            if (sc5 == 1) {
            ...
            */
            if (sc5 == 1) {
                char2Arr_t(48 + std12, _zPosX - 25, y);
                char2Arr_t(48 + std11, _zPosX - 25, y + y1);
                if (y == 0) sc5 = 0;
            }
            else char2Arr_t(48 + std1, _zPosX - 25, 0);
//          ------------------------------------- hora dezena original 6display 
            /* 
            if (sc6 == 1) {
            ...
            */
            if (sc6 == 1) {
                char2Arr_t(48 + std22, _zPosX - 17, y);
                char2Arr_t(48 + std21, _zPosX - 17, y + y1);
                if (y == 0) sc6 = 0;
            }
            else char2Arr_t(48 + std2, _zPosX - 17, 0);
//          -------------------------------------
